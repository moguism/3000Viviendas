...
@onready var address_edit : TextEdit = $CenterContainer/GridContainer/DireccionField
@onready var name_edit : TextEdit = $CenterContainer/GridContainer/NombreField
